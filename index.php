                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-lg-8">
                                ...
                                <p class="text-light fs-5 mb-4 pb-3">Cake is a delicious dessert, often enjoyed at celebrations and special occasions.</p>
                                <a href="about.php" class="btn btn-primary rounded-pill py-3 px-5">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <p>A bakery is a place where delicious bread, cakes, pastries, and cookies are made. Freshly baked goods fill the air with a delightful aroma, attracting customers who love tasty, warm, and sweet treats.</p>
                        <p>A bakery offers a variety of baked goods like bread, cakes, muffins, and pies. Skilled bakers craft these treats daily, using fresh ingredients, ensuring each bite is soft, flavorful, and absolutely delicious.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                        <div class="text-center p-4">
                            ...
                            <span>Cake is a delicious dessert, often enjoyed at celebrations and special occasions.</span>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-5">A bakery is a place where delicious bread, cakes, pastries, and cookies are made. Freshly baked goods fill the air with a delightful aroma, attracting customers who love tasty, warm, and sweet treats.</p>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item bg-white rounded p-4">
                    ...
                    <p class="mb-0">A bakery is a place where delicious bread, cakes, pastries, and cookies are made. Freshly baked goods fill the air with a delightful aroma, attracting customers who love tasty, warm, and sweet treats.</p>
                </div>
                <div class="testimonial-item bg-white rounded p-4">
                    <div class="d-flex align-items-center mb-4">
